...
def prepare_subselect_batch(base_dir, base_project):
    """Prepare a batch of subselects."""
    ...
    for cut in cuts:
        ...
        base_config["real"]["subcatchments"] = (
            cut_dir / "real" / "subcatchments.geojson"
        )
        base_config["address_overrides"]["real_subcatchments"] = (
            cut_dir / "real" / "subcatchments.geojson"
        )
        ...
        hpc_config["address_overrides"]["real_subcatchments"] = hpc_config["real"][
            "subcatchments"
        ]
